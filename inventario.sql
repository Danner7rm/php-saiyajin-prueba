...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-10-2025 a las 05:26:58
...
CREATE TABLE `categoria` (
  ...
  `catgoria_nombre` varchar(50) NOT NULL,
  `catgoria_ubicacion` varchar(150) NOT NULL
...
CREATE TABLE `producto` (
  ...
  `categoria_codigo` varchar(70) NOT NULL,
  `categoria_nombre` varchar(70) NOT NULL,
  `categoria_precio` decimal(30,2) NOT NULL,
  `categoria_stock` int(25) NOT NULL,
  `categoria_foto` varchar(500) NOT NULL,
  `categoria_id` int(7) NOT NULL,
